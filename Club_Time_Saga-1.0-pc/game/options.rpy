...
define config.name = _("Club Time Saga")
...
define build.name = "Club_Time_Saga"
...
define config.main_menu_music = "sounds/intro.wav"
...
define config.save_directory = "clubtimesaga"
